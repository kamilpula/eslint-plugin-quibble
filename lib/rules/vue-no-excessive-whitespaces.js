...
/**
 * Removes excessive whitespaces from a class list string.
 *
 * @param {string} classList - The class list string to process.
 * @returns {string | void} - The class list string without excessive whitespaces.
 */
...
/**
 * Handles an object expression by removing excessive whitespaces from class list properties.
 *
  ...
  for (const property of properties) {
    ...
    if (classList !== classListNoWhitespace) {
      context.report({
        ...
        messageId: 'excessive-whitespaces-in-class-object-expression',
...
/**
 * Handles a conditional expression by removing excessive whitespaces from class list literals.
 *
 * @param {object} context - The context object provided by the linter.
  ...
  if (consequent.type === 'Literal') {
    ...
    if (classList !== classListNoWhitespace) {
      context.report({
        node: consequent,
        loc: consequent.loc,
        messageId: 'excessive-whitespaces-in-class-array-expression',
...
export const meta = {
  ...
  messages: {
    ...
    'excessive-whitespaces-in-class-object-expression': 'Object expression for the `class` attribute should not contain excessive whitespaces.',
    'excessive-whitespaces-in-class-array-expression': 'Array expression for the `class` attribute should not contain excessive whitespaces.',
  },
  schema: [],
}
